...
# source: structure/external/Timestamp.proto
...
Timestamp = _reflection.GeneratedProtocolMessageType('Timestamp', (_message.Message,), dict(
  ...
  __module__ = 'structure.external.Timestamp_pb2'
